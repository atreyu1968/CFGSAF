...
window.EVIDENCE={api:API,
 ...
 async startExam(payload,pin){return call('/api/exam/start',{method:'POST',body:JSON.stringify({student_id:student(),course_id:course(),kind:'exam',item_id:'final',pin:pin||'',payload:payload||{}})})},
 async saveExamAnswers(id,answers){return call('/api/exam/'+encodeURIComponent(id)+'/answers',{method:'PUT',body:JSON.stringify({payload:{answers:answers||{}}})})},
 async saveExamIntegrity(id,integrity){return call('/api/exam/'+encodeURIComponent(id)+'/integrity',{method:'PUT',body:JSON.stringify({payload:{integrity:integrity||{}}})})},\n async examStatus(id){return call('/api/exam/'+encodeURIComponent(id)+'/status')},
 async submitExam(id,answers,integrity){return call('/api/exam/'+encodeURIComponent(id)+'/submit',{method:'POST',body:JSON.stringify({payload:{answers,integrity:integrity||{}}})})},
